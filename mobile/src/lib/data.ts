...
// The AI-generation logic (protocol/nutrition/movement/journey/
// week-recovery content) runs server-side — see workflows.ts, which
// calls the same Next.js /api/generate-* routes the web app uses.
// ─────────────────────────────────────────────────────────────
import {
  collection,
  doc,
